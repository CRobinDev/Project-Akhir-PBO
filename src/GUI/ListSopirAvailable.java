...
public class ListSopirAvailable extends javax.swing.JFrame {
    ...
    private String[] sopirData; // Array untuk menyimpan data sopir
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSopirAvailable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
